...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplicationLaunchOptionsKey: Any]?) -> Bool {
        ...
        let child1 = story.instantiateViewController(withIdentifier: "child1")
        child1.view.backgroundColor = UIColor.brown
        let child2 = story.instantiateViewController(withIdentifier: "child2")
        child2.view.backgroundColor = UIColor.lightGray
